...
def test_cli_version():
    ...
    assert "OpenRepro-Agent v1.57.0" in result.output
...
""",
    ...
    commands = [
        ...
        ["delivery-bundle", "boc_demo", "--zip"],
        ["multi-agent-plan", "boc_demo"],
        ["validate-multi-agent-plan", "boc_demo"],
        ["agent-board", "boc_demo", "--zip"],
        ["agent-dispatch", "boc_demo"],
        ["agent-exec-plan", "boc_demo", "--dry-run"],
        ["paper-lineage", "boc_demo"],
        ["status", "boc_demo"],
    ]
