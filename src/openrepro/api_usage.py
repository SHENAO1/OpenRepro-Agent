...
v0.4.0 keeps mock calls as the default and supports opt-in real providers.
Mocked and cached events are not counted as billable API calls. Real provider
events are summarized only from provider-returned usage data, and cost remains
zero unless a provider supplies an auditable estimate.
"""
