...
WORKSPACE_ARTIFACTS = [
    ...
    "asset_build_plan.json",
    "asset_materialization.json",
    "artifact_cache.json",
    "artifact_cache_validation.json",
    "artifact_cache_remotes.json",
    "artifact_cache_push.json",
    "artifact_cache_pull.json",
    "cache_restore_plan.json",
    "run_comparison.json",
    "run_lineage.json",
    "doctor.json",
    "repair_plan.json",
