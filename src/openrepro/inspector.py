...
def inspect_project(project_dir: Path) -> dict[str, Any]:
    ...
    summary = {
        ...
        "readiness_review_status": readiness_review["status"],
        "readiness_review_check_count": readiness_review["check_count"],
        ...
        "multi_agent_plan_status": multi_agent_plan["status"],
        "multi_agent_plan_agent_count": multi_agent_plan["agent_count"],
        "multi_agent_plan_task_count": multi_agent_plan["task_count"],
        ...
        "agent_task_spec_status": agent_task_spec["status"],
        "agent_task_spec_task_contract_count": agent_task_spec["task_contract_count"],
        "agent_task_spec_ready_task_count": agent_task_spec["ready_task_count"],
